...
func (h *hnd.Handlers) GetDebugTables(c *gin.Context) {
...
func (h *hnd.Handlers) GetDebugTableData(c *gin.Context) {
	pool := database.GetPool()
	if pool == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{"error": "database unavailable"})
		return
...
func (h *hnd.Handlers) DeleteDebugTableData(c *gin.Context) {
	pool := database.GetPool()
	if pool == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{"error": "database unavailable"})
		return
...
func (h *hnd.Handlers) DeleteDebugTableRows(c *gin.Context) {
	pool := database.GetPool()
	if pool == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{"error": "database unavailable"})
		return
