...
import { useUpdateSpace } from "#/hooks/use-console-mutations";
...
export const SpaceAvatarUploader = ({
  avatarUrl,
  name,
  spaceId,
  slug,
  ...
  return (
    <div className="flex flex-col items-center py-3 relative">
      <div className="relative">
        ...
        >
          {avatarUrl ? (
            <img alt="space avatar" className="w-full h-full object-cover" src={avatarUrl} />
          ) : (
